...
# Banner Intro
echo -e "${GREEN}\n"
figlet -f small "HEZPATY STORE" 2>/dev/null || echo "SPIDER STORE"
echo -e "${NC}"

typing "💾 PROGRAMMER: HEZPATY" "$Green"
rainbow_neon "©2024: STABLE EDITION — CYBER EDITION"
blink_warning "⚠️ WARNING: ORIGINAL SCRIPT ONLY!" "$RED"
scroll_text "🚀 INSTALL CLONED VERSIONS AT YOUR OWN RISK. t.me/hezpaty 🌌" "$BLUE"
...
ALLOWED_IPS_URL="https://raw.githubusercontent.com/hezpaty/hezpaty1/main/Database"
IP_ALLOWED=false
...
clear
REPO="https://raw.githubusercontent.com/hezpaty/hezpaty1/main/"
start=$(date +%s)
secs_to_human() {
...
echo -e "\e[32mloading...\e[0m"
clear
izinsc="https://raw.githubusercontent.com/hezpaty/hezpaty1/main/keygen"
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/hezpaty/hezpaty1/main/ubuntu/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
REPO_URL="https://raw.githubusercontent.com/hezpaty/hezpaty1/main/iptables.up.rules"
...
chmod +x /etc/rc.local
  ...
  if [ "$ONLINE" -eq 1 ] && command -v curl >/dev/null 2>&1; then
    REPO_PING="https://raw.githubusercontent.com/hezpaty/hezpaty1/main/ping.txt"
